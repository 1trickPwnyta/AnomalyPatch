...
namespace AnomalyPatch
{
    public class AnomalyPatchSettings : ModSettings
    {
        ...
        public static bool CaravanDeathRefusal = true;
        ...
        public static void DoSettingsWindowContents(Rect inRect)
        {
            ...
            listingStandard.CheckboxLabeled("AnomalyPatch_CaravanDeathRefusal".Translate(), ref CaravanDeathRefusal);
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref CaravanDeathRefusal, "CaravanDeathRefusal", true);
        }
    }
}
