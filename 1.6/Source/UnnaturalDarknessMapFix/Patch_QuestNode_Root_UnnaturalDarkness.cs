...
namespace AnomalyPatch.UnnaturalDarknessMapFix
{
    ...
    {
        public static Map GetMap(bool mustBeInfestable, int? preferMapWithMinFreeColonists, bool canBeSpace, Slate slate)
        {
            return slate.Get<Map>("map") ?? QuestGen_Get.GetMap(mustBeInfestable, preferMapWithMinFreeColonists, canBeSpace);
        }
    }
}
